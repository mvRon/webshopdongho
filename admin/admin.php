    ...
    <div class="container">
        ...
        <section>
            ...
            <form action="" method="post" class="add-product-form" enctype="multipart/form-data">
                <h3>thêm sản phẩm mới vào shop</h3>
                <input type="text" name="p_name" placeholder="nhập tên sản phẩm" class="box" required>
                <input type="number" name="p_price" min="0" placeholder="nhập giá tiền" class="box" required>
                ...
                <tbody>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="admin.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('bạn có chắc muốn xóa sản phẩm này');">
                    ...
                    <?php
                        ...
                        echo "<div class='empty'>hết sản phẩm</div>";
                    };
                    ?>
                </tbody>
